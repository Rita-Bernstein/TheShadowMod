...
public class IllusionVul extends AbstractShadowModCard {
    public static final String ID = TheShadowMod.makeID(IllusionVul.class.getSimpleName());
    ...
    public void onChoseThisOption() {
        addToBot(new ApplyPowerToAllEnemyAction((mo) -> {
            addToTop(new ApplyPowerAction(mo, AbstractDungeon.player, new VulnerablePower(mo, this.magicNumber, false)));
        }
        ));
