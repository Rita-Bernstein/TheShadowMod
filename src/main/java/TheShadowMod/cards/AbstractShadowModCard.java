...
public abstract class AbstractShadowModCard extends CustomCard {
    ...
    public AbstractShadowModCard(String id, String img, int cost, CardType type, CardRarity rarity, CardTarget target) {
        super(id, CardCrawlGame.languagePack.getCardStrings(id).NAME, img, cost, CardCrawlGame.languagePack.getCardStrings(id).DESCRIPTION, type,
                CardColorEnum.TheShadow_LIME, rarity, target);
    ...
    public AbstractCard makeStatEquivalentCopy() {
        AbstractShadowModCard card = (AbstractShadowModCard) super.makeStatEquivalentCopy();
