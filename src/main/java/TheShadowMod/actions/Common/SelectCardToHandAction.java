        ...
        if (!this.retrieveCard) {
            if (AbstractDungeon.cardRewardScreen.discoveryCard != null) {
                ...
                if (this.isExhaust) {
                    ...
                    disCard.rawDescription += CardCrawlGame.languagePack.getUIString(TheShadowMod.makeID("SelectCardToHandAction")).TEXT[0];
                    disCard.initializeDescription();
                }

                if (this.isEthereal) {
                    disCard.isEthereal = true;
                    disCard.rawDescription = CardCrawlGame.languagePack.getUIString(TheShadowMod.makeID("SelectCardToHandAction")).TEXT[0] + disCard.rawDescription;
                    disCard.initializeDescription();
                }
