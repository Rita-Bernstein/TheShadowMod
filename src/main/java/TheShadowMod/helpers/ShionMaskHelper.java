...
public class ShionMaskHelper {
    ...
    static {
        ...
        alphaMaskShader = new ShaderProgram(
                ...
                Gdx.files.internal("TheShadowMod/shader/alphaMask.fs").readString());
    ...
    public static void renderMaskedImage(SpriteBatch sb, Color renderColor, Consumer<SpriteBatch> oriTexture, Consumer<SpriteBatch> mask, boolean renderOutOfMask) {
        Texture oriImage = ShionMaskHelper.getScreenTexture(sb, oriTexture);
        Texture maskImage = ShionMaskHelper.getScreenMaskTexture(sb, mask, renderOutOfMask);
